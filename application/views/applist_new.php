    ...
    <div class="admin-container slide-effect">
        ...
        <div class="col-lg-12">
            <div class="col-lg-6">
                ...
                <input type="hidden" id="app_name" value="<?php echo $applicant_det->id; ?>">
            </div>
            <div class="col-lg-6">
                <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#generate-match">
                    <span class="glyphicon glyphicon-stats"></span>Perform Auto Job Match
                </button>
            </div>
        </div>
        <br><br><br>
