    <div class="admin-container">
        <form class="form-horizontal slide-effect" id="category-form" action="<?php echo base_url()?>maintenance/add_category/" method="POST">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <div class="error-form">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Job Category Name" name="cat_name">
                        </div>
                    </div>
                </div>
