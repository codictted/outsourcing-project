                ...
                <tbody>
                    <?php foreach($cat as $c) { ?>
                        <tr id="<?php echo $c->id ?>">
                            ...
                            ?>
                            <td><center><div id='changeState_<?php echo $c->id ?>'><?php echo $status; ?></div>
                            </center></td>
                            <td><center><?php echo $c->name; ?></center></td>
                            <td><center>
                                <button class="btn btn-success btn-sm table-btn" onclick="edit_jc(<?php echo $c->id ?>)"><span class="glyphicon glyphicon-edit"></span></button>
                                <input id='switch-state' name='my_checkbox_<?php echo $c->id ?>' type='checkbox' value='<?php echo $c->id ?>' >
                                <button class="btn btn-danger btn-sm table-btn" onclick="delete_jc(<?php echo $c->id ?>)"><span class="glyphicon glyphicon-trash"></span></button>
                            </center></td>
                        </tr>
                    <?php } ?>
                </tbody>
