                ...
                <tbody>
                    <?php foreach($job as $j) { ?>
                        <tr id="<?php echo $j->id ?>" >
                            ...
                            ?>
                            <td><center><div id='changeState_<?php echo $j->id ?>'><?php echo $status; ?></div></center></td>
                            <td><center><?php echo $j->JCName; ?></center></td>
                            <td><center><?php echo $j->name; ?></center></td>

                            <td><center>
                                <button class="btn btn-success btn-sm" onclick="edit_jp('<?php echo $j->id ?>')"><span class="glyphicon glyphicon-edit"></span></button>
                                <input id='switch-state' name='my_checkbox_<?php echo $j->id ?>' type='checkbox' value='<?php echo $j->id ?>' >
                                <button class="btn btn-danger btn-sm" onclick="delete_jp('<?php echo $j->id ?>')"><span class="glyphicon glyphicon-trash"></span></button>
                                <button class="btn btn-primary btn-sm" onclick="view_jl('<?php echo $j->id ?>')"><span class="glyphicon glyphicon-zoom-in"></span></button>
                            </center></td>
                        </tr>
                    <?php } ?>
                </tbody>
