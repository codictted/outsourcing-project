<div class="admin-container fade-effect">
    <fieldset>
        <legend>Area with most applicants</legend>
        <div id="application-tab">
            ...
            <div id="date_form">
                <div class="form-group">
                    ...
                    <form id="week-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_week_applicant_aaa/" method="POST" hidden>
                    ...
                    <form id="month-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_month_applicant_aaa/" method="POST" hidden>
                    ...
                    <form id="year-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_year_applicant_aaa/" method="POST" hidden>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-book"></i> Bar chart of Applicant's location
                        </div>
                          
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-11">
                                        <div id="applicant_date_chart"></div>
                                </div>
                            </div>
                        </div>
...
<script type='text/javascript'>
    ...
    $('#print_date_lnk').click(function(){
        ...
        ?>
        window.location.href="<?php echo base_url();?>reports/print_applicant_aaa_date?" + "mindate=" + minDate + "&" + "maxdate=" + maxDate;
    ...
    new Morris.Bar({
        element: 'applicant_date_chart',
            data: [
                <?php 
                    $endOfKey = count($date);
                    foreach ($date as $key => $dateVal) {
                        $key != $endOfKey ? print_r("{y: '$dateVal->appDate', $key: $dateVal->countApp},") : print_r("{y: '$dateVal->appLoc', $key: $dateVal->countApp}");
            ...
            labels: [
                <?php 
                    $endOfKey = count($date);
                    foreach ($date as $key => $dateVal) {
                        $key != $endOfKey ? print_r("'$dateVal->appLoc',") : print_r("'$dateVal->appLoc'");
