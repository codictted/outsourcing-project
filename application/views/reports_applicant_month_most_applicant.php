<div class="admin-container fade-effect">
    <fieldset>
        <legend>Months with most applicants</legend>
        <div id="application-tab">
            ...
            <div id="date_form">
                <div class="form-group">
                    ...
                    <form id="week-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_week_applicant_ama/" method="POST" hidden>
                    ...
                    <form id="month-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_month_applicant_ama/" method="POST" hidden>
                    ...
                    <form id="year-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_year_applicant_ama/" method="POST" hidden>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-book"></i> Bar chart of Applicants 
                        </div>
...
<script type='text/javascript'>
    ...
    $('#print_date_lnk').click(function(){
        ...
        ?>
        window.location.href="<?php echo base_url();?>reports/print_applicant_ama_date?" + "mindate=" + minDate + "&" + "maxdate=" + maxDate;
        ...
        element: 'applicant_date_chart',
            data: [
                <?php 
                    ...
                    foreach ($date as $key => $dateVal) {
                        $key != $endOfKey ? print_r("{y: '$dateVal->appDate', $key: $dateVal->countApp},") : print_r("{y: '$dateVal->clientDate', $key: $dateVal->countApp}");
            ...
            labels: [
                <?php 
                    $endOfKey = count($date);
                    foreach ($date as $key => $dateVal) {
                        $key != $endOfKey ? print_r("'$dateVal->appDate',") : print_r("'$dateVal->appDate'");
