<div class="admin-container fade-effect">
    <fieldset>
        <legend>Clients with most number of staff</legend>
        <div id="application-tab">
            ...
            <div id="date_form">
                <div class="form-group">
                    ...
                    <form id="week-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_week_client_cns/" method="POST" hidden>
                    ...
                    <form id="month-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_month_client_cns/" method="POST" hidden>
                    ...
                    <form id="year-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_year_client_cns/" method="POST" hidden>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-book"></i> Bar chart of Clients number of Staff
                        </div>
...
<script type='text/javascript'>
    ...
    $('#print_date_lnk').click(function(){
        ...
        ?>
        window.location.href="<?php echo base_url();?>reports/print_client_cns_date?" + "mindate=" + minDate + "&" + "maxdate=" + maxDate;
            ...
            data: [
                <?php 
                    ...
                    foreach ($date as $key => $dateVal) {
                        $key != $endOfKey ? print_r("{y: '$dateVal->clientDate', $key: $dateVal->countStaff},") : print_r("{y: '$dateVal->clientDate', $key: $dateVal->countStaff}");
