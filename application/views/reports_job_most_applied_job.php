<div class="admin-container fade-effect">
    <fieldset>
        <legend>Most applied jobs</legend>
        <div id="application-tab">
            ...
            <div id="date_form">
                <div class="form-group">
                    ...
                    <form id="week-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_week_job_maj/" method="POST" hidden>
                    ...
                    <form id="month-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_month_job_maj/" method="POST" hidden>
                    ...
                    <form id="year-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_year_job_maj/" method="POST" hidden>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-book"></i> Bar chart of applied Jobs
                        </div>
...
<script type='text/javascript'>
    ...
    $('#print_date_lnk').click(function(){
        ...
        ?>
        window.location.href="<?php echo base_url();?>reports/print_job_maj_date?" + "mindate=" + minDate + "&" + "maxdate=" + maxDate;
