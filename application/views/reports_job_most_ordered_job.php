<div class="admin-container fade-effect">
    <fieldset>
        <legend>Most ordered jobs</legend>
        <div id="application-tab">
            ...
            <div id="date_form">
                <div class="form-group">
                    ...
                    <form id="week-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_week_job_moj/" method="POST" hidden>
                    ...
                    <form id="month-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_month_job_moj/" method="POST" hidden>
                    ...
                    <form id="year-form" class="form-horizontal" action="<?php echo base_url()?>reports/filter_date_year_job_moj/" method="POST" hidden>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-book"></i> Bar chart of ordered Jobs
                        </div>
                          
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-11">
                                        <div id="job_date_chart"></div>
                                </div>
                            </div>
                        </div>
...
<script type='text/javascript'>
    ...
    $('#print_date_lnk').click(function(){
        ...
        ?>
        window.location.href="<?php echo base_url();?>reports/print_job_moj_date?" + "mindate=" + minDate + "&" + "maxdate=" + maxDate;
    ...
    new Morris.Bar({
        element: 'job_date_chart',
            data: [
                <?php 
                    $endOfKey = count($date);
                    foreach ($date as $key => $dateVal) {
                        $key != $endOfKey ? print_r("{y: '$dateVal->jobDate', $key: $dateVal->countJob},") : print_r("{y: '$dateVal->jobDate', $key: $dateVal->countJob}");
            ...
            labels: [
                <?php 
                    $endOfKey = count($date);
                    foreach ($date as $key => $dateVal) {
                        $key != $endOfKey ? print_r("'$dateVal->jobName',") : print_r("'$dateVal->jobName'");
